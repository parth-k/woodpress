...
//            'date' => __('Submitted', 'salon-booking-system'),
            ...
            'Confirm' => __('Confirm', 'salon-booking-system'),
            'Canceled' => __('Canceled', 'salon-booking-system'),
        );
    ...
    public function manage_column($column, $post_id)
    {
        ...
        switch ($column) {
            ...
            <form method="post">
                <button class="" style="">
                    <?php 
                echo '<a href="http://localhost/wordpress/wp-json/custom-plugin/confirm?ID=' . $post_id . ' &_method=PUT"> Confirm</a>'; ?>
                </button>
            </form>
            <?php
            break;
            ...
            <form method="post">
                <button class="" style="">
                     <?php 
                echo '<a href="http://localhost/wordpress/wp-json/custom-plugin/canceled?ID=' . $post_id . ' &_method=PUT">Reject </a>'; ?>
                </button>
            </form>
            <?php
            break;
